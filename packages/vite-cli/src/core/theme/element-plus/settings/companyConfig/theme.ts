...
const defaultThemeSetting: Theme.Setting = {
  ...
  darkMode: false,
  menuConfig: {
    darkMenuColor: '#030b31',
    lightMenuColor: '#FFFFFF',
    followSystemMenuColor: import.meta.env.VITE_THEME_COLOR,
    menuColorState: false,
    systemMenuColorState: false
  },
  layout: {
    minWidth: 1200,
  ...
  themeColor: localCache.getCache('color') ?? import.meta.env.VITE_THEME_COLOR,
  themeColorList,
  otherColor: {
    info: '#2080f0',
    success: '#52c41a',
